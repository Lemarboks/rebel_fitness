...
function RebelLogo({ compact = false }) {
  return (
    <div className="flex items-center gap-3">
      {/* Replace this editable SVG lockup with the official Rebel Fitness ATL logo file when available. */}
      <svg className={compact ? 'h-12 w-12' : 'h-14 w-14'} viewBox="0 0 96 96" role="img" aria-label="Rebel Fitness ATL logo">
        <rect width="96" height="96" fill="#050505" />
        <path d="M11 19h74l-8 13H28v10h38l-8 13H28v22H11V19Z" fill="#ffffff" />
        <path d="M52 42h32L55 77H33l21-24H40l12-11Z" fill="#ed1c24" />
        <path d="M73 19h12L62 77H50l23-58Z" fill="#ed1c24" opacity="0.82" />
      </svg>
      {!compact && (
        <span className="leading-none">
          <span className="block text-2xl font-black uppercase tracking-normal">Rebel</span>
          <span className="mt-1 block text-[10px] font-black uppercase tracking-[0.42em] text-[#ed1c24]">Fitness ATL</span>
        </span>
      )}
    </div>
  )
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-black/80 shadow-[0_18px_70px_rgba(0,0,0,0.45)] backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 lg:px-8">
        ...
        <a href="#contact" className="hidden bg-[#ed1c24] px-5 py-3 text-sm font-black uppercase tracking-[0.16em] text-white shadow-[0_0_38px_rgba(237,28,36,0.35)] transition hover:-translate-y-0.5 hover:bg-white hover:text-black lg:inline-flex">
          Join Now
        </a>
      ...
      {menuOpen && (
        <div className="border-t border-white/10 bg-black px-5 py-5 lg:hidden">
          <div className="grid gap-2">
            ...
            <a href="#contact" onClick={closeMenu} className="bg-[#ed1c24] px-4 py-3 text-center text-sm font-black uppercase tracking-[0.18em] text-white">
              Join Now
            </a>
          </div>
        </div>
...
function Hero() {
  return (
    <section id="top" className="brand-grid relative flex min-h-screen items-center pt-24">
      ...
      <div className="absolute left-0 top-28 h-28 w-1.5 bg-[#ed1c24] shadow-[0_0_40px_rgba(237,28,36,0.7)]"></div>

      <div className="relative mx-auto grid w-full max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[1.02fr_0.68fr] lg:px-8">
        <div className="reveal max-w-4xl">
          <div className="mb-7 inline-flex items-center gap-3 border border-[#ed1c24]/60 bg-[#ed1c24]/15 px-4 py-2 text-xs font-black uppercase tracking-[0.26em] text-red-100 backdrop-blur">
            <span className="h-2 w-2 bg-[#ed1c24]"></span>
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-300 sm:text-xl">
            Rebel Fitness ATL delivers high-energy coaching, premium strength programming, and a black-and-red training culture made for serious transformation.
          </p>
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="#contact" className="bg-[#ed1c24] px-7 py-4 text-center text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_20px_60px_rgba(237,28,36,0.35)] transition hover:-translate-y-1 hover:bg-white hover:text-black">
              Join Now
            </a>
          ...
          <div className="angled-surface border border-white/15 bg-black/65 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.5)] backdrop-blur-md">
            ...
            <div className="mt-5 grid gap-3">
              {['Strength Lab', 'Rebel Conditioning', 'Bootcamp ATL'].map((item) => (
                <a key={item} href="#contact" className="flex items-center justify-between border border-white/10 bg-white/[0.05] px-4 py-3 transition hover:border-[#ed1c24] hover:bg-[#ed1c24]/15">
                  <span className="font-bold">{item}</span>
                  <span className="text-sm font-black uppercase tracking-[0.14em] text-red-300">Book</span>
                </a>
              ))}
            </div>
          </div>
...
function BrandMarquee() {
  ...
  return (
    <div className="overflow-hidden border-y border-white/10 bg-[#ed1c24] py-4 text-white">
...
function SectionIntro({ eyebrow, title, copy }) {
  return (
    <div className="reveal mx-auto mb-12 max-w-3xl text-center">
      <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ed1c24]">{eyebrow}</p>
      <h2 className="mx-auto mt-3 max-w-3xl text-4xl font-black uppercase leading-tight text-white md:text-5xl">{title}</h2>
      <div className="mx-auto mt-5 h-1 w-24 bg-gradient-to-r from-transparent via-[#ed1c24] to-transparent"></div>
    ...
    <section id="about" className="bg-[#050505] px-5 py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1fr] lg:items-center">
        ...
        <div className="reveal lg:pl-8" style={{ animationDelay: '100ms' }}>
          <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ed1c24]">About Rebel Fitness ATL</p>
          <h2 className="red-sweep mt-4 text-4xl font-black uppercase leading-tight md:text-6xl">A serious training home for Atlanta rebels.</h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {['Coach-led sessions', 'Strength and conditioning', 'Results-focused community', 'Clean premium facility'].map((item) => (
              <div key={item} className="angled-surface border border-white/10 bg-white/[0.04] p-5 transition hover:border-[#ed1c24]/70 hover:bg-[#ed1c24]/10">
                <span className="text-2xl font-black text-[#ed1c24]">+</span>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {programs.map((program, index) => (
            <article key={program.title} className="reveal angled-surface group border border-white/10 bg-black p-6 transition duration-300 hover:-translate-y-2 hover:border-[#ed1c24]/80 hover:shadow-[0_24px_70px_rgba(237,28,36,0.12)]" style={{ animationDelay: `${index * 80}ms` }}>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#ed1c24]">{program.tag}</p>
              ...
              <a href="#contact" className="mt-8 inline-flex text-sm font-black uppercase tracking-[0.16em] text-white transition group-hover:text-[#ed1c24]">
                Book a Session
              </a>
            </article>
          ))}
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {memberships.map((plan) => (
            <article key={plan.name} className={`reveal border p-7 ${plan.featured ? 'border-[#ed1c24] bg-[#ed1c24] text-white shadow-[0_0_80px_rgba(237,28,36,0.24)]' : 'border-white/10 bg-white/[0.04]'}`}>
              ...
              <a href="#contact" className={`mt-8 inline-flex w-full justify-center px-5 py-4 text-sm font-black uppercase tracking-[0.16em] transition ${plan.featured ? 'bg-white text-black hover:bg-black hover:text-white' : 'bg-white text-black hover:bg-[#ed1c24] hover:text-white'}`}>
                Start Today
              </a>
            </article>
          ))}
    ...
    <section className="relative overflow-hidden bg-black px-5 py-24 lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="reveal max-w-2xl">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ed1c24]">Personal Training</p>
          <h2 className="red-sweep mt-4 text-4xl font-black uppercase leading-tight md:text-6xl">One-on-one coaching for your next level.</h2>
          <p className="mt-10 text-lg leading-8 text-zinc-400">
          ...
          <a href="#contact" className="mt-9 inline-flex bg-[#ed1c24] px-7 py-4 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:-translate-y-1 hover:bg-white hover:text-black">
            Book a Session
          </a>
        </div>
      </div>
    ...
    <section id="results" className="bg-[#101010] px-5 py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1fr] lg:items-center">
        <div className="reveal">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ed1c24]">Transformations</p>
          <h2 className="red-sweep mt-4 text-4xl font-black uppercase leading-tight md:text-6xl">Results you can feel, track, and see.</h2>
          <p className="mt-10 text-lg leading-8 text-zinc-400">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {results.map((item, index) => (
            <div key={item} className="reveal angled-surface border border-white/10 bg-black p-6" style={{ animationDelay: `${index * 90}ms` }}>
              <p className="text-4xl font-black text-[#ed1c24]">0{index + 1}</p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {galleryImages.map((src, index) => (
            <div key={src} className="reveal group relative h-72 overflow-hidden border border-white/10 bg-zinc-950" style={{ animationDelay: `${index * 60}ms` }}>
              ...
              <div className="absolute bottom-4 left-4 h-1 w-16 bg-[#ed1c24]"></div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <article key={testimonial.quote} className="reveal border border-white/10 bg-black p-7 shadow-[0_24px_70px_rgba(0,0,0,0.24)]">
              <p className="text-5xl font-black text-[#ed1c24]">"</p>
  ...
  return (
    <section id="contact" className="bg-[#050505] px-5 py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="reveal">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-[#ed1c24]">Location + Contact</p>
          <h2 className="red-sweep mt-4 text-4xl font-black uppercase leading-tight md:text-6xl">Ready to train at Rebel?</h2>
          <p className="mt-10 text-lg leading-8 text-zinc-400">
            Fill out the form, call the gym, or message Rebel Fitness ATL on Instagram to schedule your first session.
          </p>
          <div className="mt-8 grid gap-4">
            <a href={brand.phoneHref} className="border border-white/10 bg-white/[0.04] p-5 font-bold transition hover:border-[#ed1c24]">Phone: {brand.phoneLabel}</a>
            <a href={brand.emailHref} className="border border-white/10 bg-white/[0.04] p-5 font-bold transition hover:border-[#ed1c24]">Email: {brand.emailLabel}</a>
        ...
        <form className="reveal border border-white/10 bg-[#111] p-6 shadow-[0_30px_90px_rgba(0,0,0,0.45)] md:p-8" style={{ animationDelay: '120ms' }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="grid gap-2 text-sm font-bold uppercase tracking-[0.14em] text-zinc-300">
              Name
              <input className="border border-white/10 bg-black px-4 py-3 text-white outline-none transition focus:border-[#ed1c24]" placeholder="Your name" />
            </label>
            <label className="grid gap-2 text-sm font-bold uppercase tracking-[0.14em] text-zinc-300">
              Phone
              <input className="border border-white/10 bg-black px-4 py-3 text-white outline-none transition focus:border-[#ed1c24]" placeholder="Your phone" />
            </label>
          </div>
          <label className="mt-5 grid gap-2 text-sm font-bold uppercase tracking-[0.14em] text-zinc-300">
            Goal
            <select className="border border-white/10 bg-black px-4 py-3 text-white outline-none transition focus:border-[#ed1c24]">
          ...
          <label className="mt-5 grid gap-2 text-sm font-bold uppercase tracking-[0.14em] text-zinc-300">
            Message
            <textarea className="min-h-32 border border-white/10 bg-black px-4 py-3 text-white outline-none transition focus:border-[#ed1c24]" placeholder="Tell us what you want to change." />
          </label>
          <button type="button" className="mt-6 w-full bg-[#ed1c24] px-7 py-4 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:bg-white hover:text-black">
            Send Message
          </button>
        </form>
      </div>
...
function SocialCta() {
  return (
    <section className="bg-[#ed1c24] px-5 py-16 text-white lg:px-8">
